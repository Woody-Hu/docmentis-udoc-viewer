...
export const wasm_load: (a: number, b: number, c: number, d: number, e: number) => number;
...
export const wasm_render_page_layers: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
...
export const __wasm_bindgen_func_elem_34631: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_34633: (a: number, b: number, c: number, d: number) => void;
