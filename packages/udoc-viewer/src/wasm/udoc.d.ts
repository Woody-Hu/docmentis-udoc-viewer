...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_23003: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_23016: (a: number, b: number, c: number, d: number) => void;
