...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_34679: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_34681: (a: number, b: number, c: number, d: number) => void;
