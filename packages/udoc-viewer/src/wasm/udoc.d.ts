...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_22806: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_22819: (a: number, b: number, c: number, d: number) => void;
